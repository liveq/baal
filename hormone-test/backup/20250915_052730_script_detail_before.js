    ...
    detail_content.innerHTML = `
        <div class="detail-container">
            <div class="detail-left">
                <button class="back-button" onclick="go_back()">← 뒤로가기</button>
                <div class="detail-header">
                    <img src="https://api.dicebear.com/7.x/${get_avatar_style(type)}/svg?seed=${type}&backgroundColor=${get_bg_color(type)}" 
                         alt="${detail.title}" class="detail-avatar">
            ...
            <div class="detail-right">
                ...
                <div class="detail-stories">
                    ...
                    <div class="stories-list">
                        ${detail.stories.map(story => `<div class="story-item">${story}</div>`).join('')}
                    </div>
                </div>
            </div>
        </div>
